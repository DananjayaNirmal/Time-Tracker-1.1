...
<div class = "text-light text-md-center mt-2">
<h3>TT+</h3>
<h6>Track Time, Plus Productivity</h6>
</div>

<div class = "mx-auto p-3 container text-light"  style = "width:40%; border-radius:10px; margin-top:1%;">
...
<button class = "btn btn-transparent btn-lg text-primary"><i class="bi bi-arrow-right-circle"></i></button>
...
<div class = "bg-light bg-opacity-10 mx-auto p-3 container"  style = "width:40%; border-radius:10px; margin-top:7%;">
...
<h1>00.00.00</h1>
<br>
<span><button class = "btn btn-lg" style = "background-color:transparent;"><i class="bi bi-play"></i></button></span>
<button class = "btn btn-transparent btn-lg"><i class="bi bi-pause-fill"></i></button>
<button class = "btn btn-transparent btn-lg"><i class="bi bi-stop-fill"></i></button>
